...
def search_routes(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            routes_list = Route.objects.filter(departure_station__name=departure_station_name, arrival_station__name=arrival_station_name)
            routes_list.order_by("departure_time", "arrival_time")
